...
Revision ID: 492f4e65b87e
Revises: 
Create Date: 2025-07-20 06:33:45.339558
...
def upgrade():
    ...
    sa.CheckConstraint('invested_amount <= full_amount', name='check_invested_not_exceed'),
